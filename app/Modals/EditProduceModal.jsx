...
const EditProduceModal = ({  isVisible, onClose ,editProduce , initial_produce_data,produce_name}) => {
    ...
    useEffect(() => {
        if(initial_produce_data == undefined){
            return;
        }
        setPrice(initial_produce_data.price);
        setStock(initial_produce_data.stock);
    }, [initial_produce_data]);
    ...
    return (
        ...
        <View  style={styles.modal_container}>
                ...
                <InputField 
                    ...
                    placeholder="Pretul produsului (per kg)" 
                    value={Price}
                    ...
                    <View style={styles.save_exit_buttons_container}>
                        ...
                        <SquaredButton onPress={()=>editProduce(Stock,Price)} title="salveaza"></SquaredButton>
                    </View>
            </View>
        </Dialog>
    );
